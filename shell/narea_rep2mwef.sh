#!/bin/bash
#SBATCH --job-name=narea_rep2mwef
#SBATCH --output=logs/narea_rep2mwef.out
#SBATCH --error=logs/narea_rep2mwef.err
...
repetition=2
traits=("1681_wave_1703" "773_wave_771" "1089_wave_402")
