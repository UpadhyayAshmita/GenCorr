#!/bin/bash
#SBATCH --job-name=psTcombinedmwef
#SBATCH --output=logs/psTcombinedmwef_%A_%a.out
#SBATCH --error=logs/psTcombinedmwef_%A_%a.err
...
# Array of traits
declare -a traits=("1954_wave_2311" "722_wave_1782" "467_wave_2178" "705_wave_1825" "654_wave_1088")
...
Rscript scripts/psT_combined_mwef.R --trait1 $trait1 --repetition $rep_index --cv_scheme $cv_scheme
