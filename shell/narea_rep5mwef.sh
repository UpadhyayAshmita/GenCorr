#!/bin/bash
#SBATCH --job-name=narea_rep5mwef
#SBATCH --output=logs/narea_rep5mwef.out
#SBATCH --error=logs/narea_rep5mwef.err
...
repetition=5
traits=("754_wave_367" "1138_wave_744" "1699_wave_1700")
