#!/bin/bash
#SBATCH --job-name=STcombined
#SBATCH --output=logs/STcombined_%A_%a.out
#SBATCH --error=logs/STcombined_%A_%a.err
...
Rscript scripts/ST_combined.R --trait1 $trait1 --repetition $rep_index --cv_scheme $cv_scheme
