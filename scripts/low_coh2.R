...
Nwave_lowcoh2<- wave %>% select(1:10, narea,wave_524,wave_681)
wave_524_wave_681 <- paste("wave_524", "wave_681", sep = "_")
Nwave_lowcoh2[[wave_524_wave_681]] <- Nwave_lowcoh2[["wave_524"]] / Nwave_lowcoh2[["wave_681"]]
Nwave_lowcoh2<- Nwave_lowcoh2 %>% select(-wave_524,-wave_681)
write.csv(Nwave_lowcoh2, "./data/Nwave_lowcoh2.csv", row.names = F)
...
selected <- S |>
  ...
  slice_min(coh2, n = 1) |>
  mutate(across(where(is.double), \(x) round(x, 4)))
Swave_lowcoh2<- wave %>% select(1:9, sla,wave_1998,wave_2482)
wave_1998_wave_2482 <- paste("wave_1998", "wave_2482", sep = "_")
Swave_lowcoh2[[wave_1998_wave_2482]] <- Swave_lowcoh2[["wave_1998"]] / Swave_lowcoh2[["wave_2482"]]
Swave_lowcoh2<- Swave_lowcoh2 %>% select(-wave_1998,-wave_2482)
write.csv(Swave_lowcoh2, "./data/Swave_lowcoh2.csv", row.names = F)
...
selected <- pn |>
  ...
  slice_min(coh2, n = 1) |>
  mutate(across(where(is.double), \(x) round(x, 4)))
pnwave_lowcoh2<- wave %>% select(1:9, fs_plsr_narea,wave_2201,wave_409)
wave_2201_wave_409 <- paste("wave_2201", "wave_409", sep = "_")
pnwave_lowcoh2[[wave_2201_wave_409]] <- pnwave_lowcoh2[["wave_2201"]] / pnwave_lowcoh2[["wave_409"]]
pnwave_lowcoh2<- pnwave_lowcoh2 %>% select(-wave_2201,-wave_409)
write.csv(pnwave_lowcoh2, "./data/pnwave_lowcoh2.csv", row.names = F)
...
selected <- ps |>
  ...
  slice_min(coh2, n = 1) |>
  mutate(across(where(is.double), \(x) round(x, 4)))
pswave_lowcoh2<- wave %>% select(1:9, plsr_sla_sorghum,wave_1434,wave_2258)
wave_1434_wave_2258<- paste("wave_1434", "wave_2258", sep = "_")

pswave_lowcoh2[[wave_1434_wave_2258]] <- pswave_lowcoh2[["wave_1434"]] / pswave_lowcoh2[["wave_2258"]]
pswave_lowcoh2<- pswave_lowcoh2 %>% select(-wave_1434,-wave_2258)
write.csv(pswave_lowcoh2, "./data/pswave_lowcoh2.csv", row.names = F)

Nwave_lowcoh2<- read.csv("./data/Nwave_lowcoh2.csv")
# ---------------------processing of data---------------------
Nwave_lowcoh2<-
...
fwrite( Nratio_bluesMW1, "./output/Nratio_bluesMW1.csv", row.names = FALSE)
...
fwrite( Nratio_bluesEF1, "./output/Nratio_bluesEF1.csv", row.names = FALSE)
Nratio_bluesEF1<- read.csv("./output/Nratio_bluesEF1.csv")
...
fwrite( NbluesEF1, "./output/NbluesEF1.csv", row.names = FALSE)
...
fwrite( NbluesMW1, "./output/NbluesMW1.csv", row.names = FALSE)
#combining blues for trait and waveratio for Ef and MW location
NbluesEF1<- read.csv("./output/NbluesEF1.csv")
NbluesMW1<- read.csv("./output/NbluesMW1.csv")
...
write.csv(N_blues1,"./output/N_blues1.csv", row.names = F)
#SLA blues
Swave_lowcoh2 <- read.csv("./data/Swave_lowcoh2.csv")
# ---------------------processing of data---------------------
Swave_lowcoh2<-
...
fwrite( Sratio_bluesMW1, "./output/sla/Sratio_bluesMW1.csv", row.names = FALSE)
Sratio_bluesMW1<- read.csv("./output/sla/Sratio_bluesMW1.csv")
...
fwrite( Sratio_bluesEF1, "./output/sla/Sratio_bluesEF1.csv", row.names = FALSE)
...
fwrite( SbluesEF1, "./output/sla/SbluesEF1.csv", row.names = FALSE)
...
fwrite( SbluesMW1, "./output/sla/SbluesMW1.csv", row.names = FALSE)
SbluesEF1<- read.csv("./output/sla/SbluesEF1.csv")
SbluesMW1<- read.csv("./output/sla/SbluesMW1.csv")
...
write.csv(S_blues1, "./output/sla/S_blues1.csv", row.names = F)

#plsr-narea(pn)
pnwave_lowcoh2 <- read.csv("./data/pnwave_lowcoh2.csv")
# ---------------------processing of data---------------------
pnwave_lowcoh2<-
...
fwrite( pnratio_bluesMW1, "./output/plsr_narea/pnratio_bluesMW1.csv", row.names = FALSE)
...
fwrite( pnratio_bluesEF1, "./output/plsr_narea/pnratio_bluesEF1.csv", row.names = FALSE)
pnratio_bluesEF1<- read.csv("./output/plsr_narea/pnratio_bluesEF1.csv")
pnratio_bluesMW1<- read.csv("./output/plsr_narea/pnratio_bluesMW1.csv")
...
fwrite( pnbluesEF1, "./output/plsr_narea/pnbluesEF1.csv", row.names = FALSE)
...
fwrite( pnbluesMW1, "./output/plsr_narea/pnbluesMW1.csv", row.names = FALSE)
pnbluesEF1<- read.csv("./output/plsr_narea/pnbluesEF1.csv")
pnbluesMW1<- read.csv("./output/plsr_narea/pnbluesMW1.csv")
...
write.csv(pn_blues1, "./output/plsr_narea/pn_blues1.csv", row.names = F)


#plsr-sla(ps)
pswave_lowcoh2 <- read.csv("./data/pswave_lowcoh2.csv")
# ---------------------processing of data---------------------
pswave_lowcoh2<-
...
fwrite( psratio_bluesMW1, "./output/plsr_sla/psratio_bluesMW1.csv", row.names = FALSE)
...
fwrite( psratio_bluesEF1, "./output/plsr_sla/psratio_bluesEF1.csv", row.names = FALSE)
...
fwrite( psbluesEF1, "./output/plsr_sla/psbluesEF1.csv", row.names = FALSE)
...
fwrite( psbluesMW1, "./output/plsr_sla/psbluesMW1.csv", row.names = FALSE)
psbluesEF1<- read.csv("./output/plsr_sla/psbluesEF1.csv")
psbluesMW1<- read.csv("./output/plsr_sla/psbluesMW1.csv")
...
write.csv(ps_blues1, "./output/plsr_sla/ps_blues1.csv", row.names = F)
