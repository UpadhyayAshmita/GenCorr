...
N_blues <- read.csv(paste0("N_blues1_rep", repetition, ".csv"))
...
ps_blues <- read.csv(paste0("ps_blues1_rep", repetition, ".csv"))
...
run_trait_model <- function(trait, trait_index, cv_scheme) {
  ac_rep <- c()
  fname <- paste0("psT", trait_index, "_", cv_scheme, "_rep", repetition, "_mwef.txt")
  ac_fname <- paste0("acpsT", trait_index, "_", cv_scheme, "_rep", repetition, "_mwef.txt")
...
run_trait_model(trait1, repetition, cv_scheme)
