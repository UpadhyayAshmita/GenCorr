...
#replication 1
S <- fread("./output/sla_breakdown1.csv", data.table = F)
...
Sratios <- wave |> select(wave_1726_wave_1363:wave_2255_wave_1800)
Sratios <- t(Sratios)
...
write.csv(Sratios,"./output/Sratios_rep1.csv", row.names=F)
Sratios<- read.csv("./output/Sratios_rep1.csv")
...
write.csv(Sratio_transform, "./output/Sratio_transform_rep1.csv", row.names=F)
Sratio_transform<- read.csv("./output/Sratio_transform_rep1.csv")
com_col <- colnames(wave)[colnames(wave) %in% Sratio_transform$wave_sel]
Swave_pheno<- wave %>% select(1:9, sla,com_col)
write.csv(Swave_pheno,"./output/Swave_pheno_rep1.csv", row.names = F)
Swave<- read.csv("./output/Swave_pheno_rep1.csv")
#plotting
...
#replication 2
S <- fread("./output/sla_breakdown2.csv", data.table = F)
phenotypes_whole <- read.table("./data/phenotypes_whole.csv", header = T, sep = ",")
Name2<- unique(phenotypes_whole$Name2)
indv_sample<- read.csv("./data/sample_per_rep.csv")
...
sel$rowname <- paste0(sel$wave_1, "_", sel$wave_2)
Sratios <- wave |> select(wave_1727_wave_1672:wave_1691_wave_978)
Sratios <- t(Sratios)
colnames(Sratios) <- wave$plot_id
#distance
dist <- get_dist(Sratios, method = "pearson")
...
Sratios<- as.data.frame(Sratios)
write.csv(Sratios,"./output/Sratios_rep2.csv", row.names=F)
Sratios<- read.csv("./output/Sratios_rep2.csv")
...
Sratio_transform <- Sratio_sel %>%
  mutate(across(c(wave_1, wave_2), ~paste("wave", ., sep = "_"))) %>%
  mutate(wave_sel= paste(wave_1, wave_2, sep = "_")) %>% select(-group,-coh2,-diff)
write.csv(Sratio_transform, "./output/Sratio_transform_rep2.csv", row.names=F)
Sratio_transform<- read.csv("./output/Sratio_transform_rep2.csv")
com_col <- colnames(wave)[colnames(wave) %in% Sratio_transform$wave_sel]
Swave_pheno<- wave %>% select(1:9, sla,com_col)
write.csv(Swave_pheno,"./output/Swave_pheno_rep2.csv", row.names = F)
Swave<- read.csv("./output/Swave_pheno_rep2.csv")
#plotting
...
#replication 3
S <- fread("./output/sla_breakdown3.csv", data.table = F)
phenotypes_whole <- read.table("./data/phenotypes_whole.csv", header = T, sep = ",")
Name2<- unique(phenotypes_whole$Name2)
indv_sample<- read.csv("./data/sample_per_rep.csv")
...
sel$rowname <- paste0(sel$wave_1, "_", sel$wave_2)
Sratios <- wave |> select(wave_751_wave_805:wave_2077_wave_1489)
Sratios <- t(Sratios)
colnames(Sratios) <- wave$plot_id
#distance
dist <- get_dist(Sratios, method = "pearson")
...
Sratios<- as.data.frame(Sratios)
write.csv(Sratios,"./output/Sratios_rep3.csv", row.names=F)
Sratios<- read.csv("./output/Sratios_rep3.csv")
...
Sratio_transform <- Sratio_sel %>%
  mutate(across(c(wave_1, wave_2), ~paste("wave", ., sep = "_"))) %>%
  mutate(wave_sel= paste(wave_1, wave_2, sep = "_")) %>% select(-group,-coh2,-diff)
write.csv(Sratio_transform, "./output/Sratio_transform_rep3.csv", row.names=F)
Sratio_transform<- read.csv("./output/Sratio_transform_rep3.csv")
com_col <- colnames(wave)[colnames(wave) %in% Sratio_transform$wave_sel]
Swave_pheno<- wave %>% select(1:9, sla,com_col)
write.csv(Swave_pheno,"./output/Swave_pheno_rep3.csv", row.names = F)
Swave<- read.csv("./output/Swave_pheno_rep3.csv")
#plotting
...
#replication4
S <- fread("./output/sla_breakdown4.csv", data.table = F)
...
sel$rowname <- paste0(sel$wave_1, "_", sel$wave_2)
Sratios <- wave |> select(wave_2157_wave_1854:wave_1706_wave_1070)
Sratios <- t(Sratios)
colnames(Sratios) <- wave$plot_id
#distance
dist <- get_dist(Sratios, method = "pearson")
...
Sratios<- as.data.frame(Sratios)
write.csv(Sratios,"./output/Sratios_rep4.csv", row.names=F)
Sratios<- read.csv("./output/Sratios_rep4.csv")
...
Sratio_transform <- Sratio_sel %>%
  mutate(across(c(wave_1, wave_2), ~paste("wave", ., sep = "_"))) %>%
  mutate(wave_sel= paste(wave_1, wave_2, sep = "_")) %>% select(-group,-coh2,-diff)
write.csv(Sratio_transform, "./output/Sratio_transform_rep4.csv", row.names=F)
Sratio_transform<- read.csv("./output/Sratio_transform_rep4.csv")
com_col <- colnames(wave)[colnames(wave) %in% Sratio_transform$wave_sel]
Swave_pheno<- wave %>% select(1:9, sla,com_col)
write.csv(Swave_pheno,"./output/Swave_pheno_rep4.csv", row.names = F)
Swave<- read.csv("./output/Swave_pheno_rep4.csv")
#plotting
...
#replication 5
S <- fread("./output/sla_breakdown5.csv", data.table = F)
...
sel$rowname <- paste0(sel$wave_1, "_", sel$wave_2)
Sratios <- wave |> select(wave_751_wave_753:wave_404_wave_978)
Sratios <- t(Sratios)
colnames(Sratios) <- wave$plot_id
#distance
dist <- get_dist(Sratios, method = "pearson")
...
Sratios<- as.data.frame(Sratios)
write.csv(Sratios,"./output/Sratios_rep5.csv", row.names=F)
Sratios<- read.csv("./output/Sratios_rep5.csv")
...
Sratio_transform <- Sratio_sel %>%
  mutate(across(c(wave_1, wave_2), ~paste("wave", ., sep = "_"))) %>%
  mutate(wave_sel= paste(wave_1, wave_2, sep = "_")) %>% select(-group,-coh2,-diff)
write.csv(Sratio_transform, "./output/Sratio_transform_rep5.csv", row.names=F)
Sratio_transform<- read.csv("./output/Sratio_transform_rep5.csv")
com_col <- colnames(wave)[colnames(wave) %in% Sratio_transform$wave_sel]
Swave_pheno<- wave %>% select(1:9, sla,com_col)
write.csv(Swave_pheno,"./output/Swave_pheno_rep5.csv", row.names = F)
Swave<- read.csv("./output/Swave_pheno_rep5.csv")
#plotting
...
S_blues_rep1<- droplevels(S_blues_rep1[S_blues_rep1$taxa %in%rownames(kin), ])#filtering indv that are present both in kinship and phenotypic data
...
S_blues_rep2<- subset(Sblues_rep2, !is.na(taxa))%>%
  select(-name2,-Corrected_names)
S_blues_rep2<- droplevels(S_blues_rep2[S_blues_rep2$taxa %in%rownames(kin), ])#filtering indv that are present both in kinship and phenotypic data
...
S_blues_rep3<- droplevels(S_blues_rep3[S_blues_rep3$taxa %in%rownames(kin), ])#filtering indv that are present both in kinship and phenotypic data
...
S_blues_rep4<- droplevels(S_blues_rep4[S_blues_rep4$taxa %in%rownames(kin), ])#filtering indv that are present both in kinship and phenotypic data
...
S_blues_rep5<- droplevels(S_blues_rep5[S_blues_rep5$taxa %in%rownames(kin), ])#filtering indv that are present both in kinship and phenotypic data
