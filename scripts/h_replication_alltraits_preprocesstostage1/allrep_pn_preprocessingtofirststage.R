...
#replication 1
pn <- fread("./output/pn_breakdown1.csv", data.table = F)
...
pnratios <- wave |> select(wave_823_wave_726:wave_1348_wave_1788)
pnratios <- t(pnratios)
...
write.csv(pnratios,"./output/pnratios_rep1.csv", row.names=F)
pnratios<- read.csv("./output/pnratios_rep1.csv")
...
write.csv(pnratio_transform, "./output/pnratio_transform_rep1.csv", row.names=F)
pnratio_transform<- read.csv("./output/pnratio_transform_rep1.csv")
com_col <- colnames(wave)[colnames(wave) %in% pnratio_transform$wave_sel]
pnwave_pheno<- wave %>% select(1:9,fs_plsr_narea,com_col)
write.csv(pnwave_pheno,"./output/pnwave_pheno_rep1.csv", row.names = F)
pnwave<- read.csv("./output/pnwave_pheno_rep1.csv")
#plotting
...
#replication 2
pn <- fread("./output/pn_breakdown2.csv", data.table = F)
phenotypes_whole <- read.table("./data/phenotypes_whole.csv", header = T, sep = ",")
Name2<- unique(phenotypes_whole$Name2)
indv_sample<- read.csv("./data/sample_per_rep.csv")
...
sel$rowname <- paste0(sel$wave_1, "_", sel$wave_2)
pnratios <- wave |> select(wave_1093_wave_2395:wave_997_wave_2313)
pnratios <- t(pnratios)
colnames(pnratios) <- wave$plot_id
#distance
dist <- get_dist(pnratios, method = "pearson")
...
pnratios<- as.data.frame(pnratios)
write.csv(pnratios,"./output/pnratios_rep2.csv", row.names=F)
pnratios<- read.csv("./output/pnratios_rep2.csv")
...
pnratio_transform <- pnratio_sel %>%
  mutate(across(c(wave_1, wave_2), ~paste("wave", ., sep = "_"))) %>%
  mutate(wave_sel= paste(wave_1, wave_2, sep = "_")) %>% select(-group,-coh2,-diff)
write.csv(pnratio_transform, "./output/pnratio_transform_rep2.csv", row.names=F)
pnratio_transform<- read.csv("./output/pnratio_transform_rep2.csv")
com_col <- colnames(wave)[colnames(wave) %in% pnratio_transform$wave_sel]
pnwave_pheno<- wave %>% select(1:9,fs_plsr_narea,com_col)
write.csv(pnwave_pheno,"./output/pnwave_pheno_rep2.csv", row.names = F)
pnwave<- read.csv("./output/pnwave_pheno_rep2.csv")
#plotting
l <- pnratio_transform |>
  mutate(wave_1 = as.numeric(gsub("_.*", "",gsub("wave_","", wave_1))),
         wave_2 = as.numeric(gsub(".*_","", wave_2))) |> ungroup() |>
...
#replication 3
pn <- fread("./output/pn_breakdown3.csv", data.table = F)
phenotypes_whole <- read.table("./data/phenotypes_whole.csv", header = T, sep = ",")
Name2<- unique(phenotypes_whole$Name2)
indv_sample<- read.csv("./data/sample_per_rep.csv")
...
sel$rowname <- paste0(sel$wave_1, "_", sel$wave_2)
pnratios <- wave |> select(wave_823_wave_744:wave_1261_wave_2476)
pnratios <- t(pnratios)
colnames(pnratios) <- wave$plot_id
#distance
dist <- get_dist(pnratios, method = "pearson")
...
pnratios<- as.data.frame(pnratios)
write.csv(pnratios,"./output/pnratios_rep3.csv", row.names=F)
pnratios<- read.csv("./output/pnratios_rep3.csv")
...
pnratio_transform <- pnratio_sel %>%
  mutate(across(c(wave_1, wave_2), ~paste("wave", ., sep = "_"))) %>%
  mutate(wave_sel= paste(wave_1, wave_2, sep = "_")) %>% select(-group,-coh2,-diff)
write.csv(pnratio_transform, "./output/pnratio_transform_rep3.csv", row.names=F)
pnratio_transform<- read.csv("./output/pnratio_transform_rep3.csv")
com_col <- colnames(wave)[colnames(wave) %in% pnratio_transform$wave_sel]
pnwave_pheno<- wave %>% select(1:9,fs_plsr_narea,com_col)
write.csv(pnwave_pheno,"./output/pnwave_pheno_rep3.csv", row.names = F)
pnwave<- read.csv("./output/pnwave_pheno_rep3.csv")
#plotting
...
#replication4
pn <- fread("./output/pn_breakdown4.csv", data.table = F)
phenotypes_whole <- read.table("./data/phenotypes_whole.csv", header = T, sep = ",")
Name2<- unique(phenotypes_whole$Name2)
indv_sample<- read.csv("./data/sample_per_rep.csv")
...
sel$rowname <- paste0(sel$wave_1, "_", sel$wave_2)
pnratios <- wave |> select(wave_1697_wave_1711:wave_871_wave_1706)
pnratios <- t(pnratios)
colnames(pnratios) <- wave$plot_id
#distance
dist <- get_dist(pnratios, method = "pearson")
...
pnratios<- as.data.frame(pnratios)
write.csv(pnratios,"./output/pnratios_rep4.csv", row.names=F)
pnratios<- read.csv("./output/pnratios_rep4.csv")
...
pnratio_transform <- pnratio_sel %>%
  mutate(across(c(wave_1, wave_2), ~paste("wave", ., sep = "_"))) %>%
  mutate(wave_sel= paste(wave_1, wave_2, sep = "_")) %>% select(-group,-coh2,-diff)
write.csv(pnratio_transform, "./output/pnratio_transform_rep4.csv", row.names=F)
pnratio_transform<- read.csv("./output/pnratio_transform_rep4.csv")
com_col <- colnames(wave)[colnames(wave) %in% pnratio_transform$wave_sel]
pnwave_pheno<- wave %>% select(1:9,fs_plsr_narea,com_col)
write.csv(pnwave_pheno,"./output/pnwave_pheno_rep4.csv", row.names = F)
pnwave<- read.csv("./output/pnwave_pheno_rep4.csv")
#plotting
...
#replication 5
pn <- fread("./output/pn_breakdown5.csv", data.table = F)
phenotypes_whole <- read.table("./data/phenotypes_whole.csv", header = T, sep = ",")
Name2<- unique(phenotypes_whole$Name2)
indv_sample<- read.csv("./data/sample_per_rep.csv")
...
sel$rowname <- paste0(sel$wave_1, "_", sel$wave_2)
pnratios <- wave |> select(wave_1001_wave_736:wave_739_wave_383)
pnratios <- t(pnratios)
colnames(pnratios) <- wave$plot_id
#distance
dist <- get_dist(pnratios, method = "pearson")
...
pnratios<- as.data.frame(pnratios)
write.csv(pnratios,"./output/pnratios_rep5.csv", row.names=F)
pnratios<- read.csv("./output/pnratios_rep5.csv")
...
pnratio_transform <- pnratio_sel %>%
  mutate(across(c(wave_1, wave_2), ~paste("wave", ., sep = "_"))) %>%
  mutate(wave_sel= paste(wave_1, wave_2, sep = "_")) %>% select(-group,-coh2,-diff)
write.csv(pnratio_transform, "./output/pnratio_transform_rep5.csv", row.names=F)
pnratio_transform<- read.csv("./output/pnratio_transform_rep5.csv")
com_col <- colnames(wave)[colnames(wave) %in% pnratio_transform$wave_sel]
pnwave_pheno<- wave %>% select(1:9,fs_plsr_narea,com_col)
write.csv(pnwave_pheno,"./output/pnwave_pheno_rep5.csv", row.names = F)
pnwave<- read.csv("./output/pnwave_pheno_rep5.csv")
#plotting
...
pn_blues_rep1<- droplevels(pn_blues_rep1[pn_blues_rep1$taxa %in%rownames(kin), ])#filtering indv that are present both in kinship and phenotypic data
...
pn_blues_rep2<- subset(pnblues_rep2, !is.na(taxa))%>%
  select(-name2,-Corrected_names)
pn_blues_rep2<- droplevels(pn_blues_rep2[pn_blues_rep2$taxa %in%rownames(kin), ])#filtering indv that are present both in kinship and phenotypic data
...
pn_blues_rep3<- droplevels(pn_blues_rep3[pn_blues_rep3$taxa %in%rownames(kin), ])#filtering indv that are present both in kinship and phenotypic data
...
pn_blues_rep4 <- droplevels(pn_blues_rep4[pn_blues_rep4$taxa %in%rownames(kin), ])#filtering indv that are present both in kinship and phenotypic data
...
pn_blues_rep5<- droplevels(pn_blues_rep5[pn_blues_rep5$taxa %in%rownames(kin), ])#filtering indv that are present both in kinship and phenotypic data
