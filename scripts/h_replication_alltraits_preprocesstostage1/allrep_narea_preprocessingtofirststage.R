...
#replication 1
N <- fread("./output/narea_breakdown1.csv", data.table = F)
...
Nratios <- wave |> select(wave_1093_wave_2310:wave_1304_wave_2273)
Nratios <- t(Nratios)
...
write.csv(Nratios,"./output/Nratios_rep1.csv", row.names=F)
Nratios<- read.csv("./output/Nratios_rep1.csv")
...
write.csv(Nratio_transform, "./output/Nratio_transform_rep1.csv", row.names=F)
...
sel$rowname <- paste0(sel$wave_1, "_", sel$wave_2)
Nratios <- wave |> select(wave_1659_wave_1716:wave_1098_wave_2273)
Nratios <- t(Nratios)
colnames(Nratios) <- wave$plot_id
#distance
dist <- get_dist(Nratios, method = "pearson")
...
Nratios<- as.data.frame(Nratios)
write.csv(Nratios,"./output/Nratios_rep2.csv", row.names=F)
Nratios<- read.csv("./output/Nratios_rep2.csv")
...
Nratio_transform <- Nratio_sel %>%
  mutate(across(c(wave_1, wave_2), ~paste("wave", ., sep = "_"))) %>%
  mutate(wave_sel= paste(wave_1, wave_2, sep = "_")) %>% select(-group,-coh2,-diff)
write.csv(Nratio_transform, "./output/Nratio_transform_rep2.csv", row.names=F)
Nratio_transform<- read.csv("./output/Nratio_transform_rep2.csv")
com_col <- colnames(wave)[colnames(wave) %in% Nratio_transform$wave_sel]
Nwave_pheno<- wave %>% select(1:10, com_col)
write.csv(Nwave_pheno,"./output/Nwave_pheno_rep2.csv", row.names = F)
Nwave<- read.csv("./output/Nwave_pheno_rep2.csv")
#plotting
...
#replication 3
N <- fread("./output/narea_breakdown3.csv", data.table = F)
phenotypes_whole <- read.table("./data/phenotypes_whole.csv", header = T, sep = ",")
Name2<- unique(phenotypes_whole$Name2)
indv_sample<- read.csv("./data/sample_per_rep.csv")
...
sel$rowname <- paste0(sel$wave_1, "_", sel$wave_2)
Nratios <- wave |> select(wave_1693_wave_1696:wave_1565_wave_2262)
Nratios <- t(Nratios)
colnames(Nratios) <- wave$plot_id
#distance
dist <- get_dist(Nratios, method = "pearson")
...
Nratios<- as.data.frame(Nratios)
write.csv(Nratios,"./output/Nratios_rep3.csv", row.names=F)
Nratios<- read.csv("./output/Nratios_rep3.csv")
...
Nratio_transform <- Nratio_sel %>%
  mutate(across(c(wave_1, wave_2), ~paste("wave", ., sep = "_"))) %>%
  mutate(wave_sel= paste(wave_1, wave_2, sep = "_")) %>% select(-group,-coh2,-diff)
write.csv(Nratio_transform, "./output/Nratio_transform_rep3.csv", row.names=F)
Nratio_transform<- read.csv("./output/Nratio_transform_rep3.csv")
com_col <- colnames(wave)[colnames(wave) %in% Nratio_transform$wave_sel]
Nwave_pheno<- wave %>% select(1:10, com_col)
write.csv(Nwave_pheno,"./output/Nwave_pheno_rep3.csv", row.names = F)
Nwave<- read.csv("./output/Nwave_pheno_rep3.csv")
#plotting
...
#replication-4
N <- fread("./output/narea_breakdown4.csv", data.table = F)
phenotypes_whole <- read.table("./data/phenotypes_whole.csv", header = T, sep = ",")
Name2<- unique(phenotypes_whole$Name2)
indv_sample<- read.csv("./data/sample_per_rep.csv")
...
sel$rowname <- paste0(sel$wave_1, "_", sel$wave_2)
Nratios <- wave |> select(wave_1692_wave_1705:wave_1090_wave_1729)
Nratios <- t(Nratios)
colnames(Nratios) <- wave$plot_id
#distance
dist <- get_dist(Nratios, method = "pearson")
...
Nratios<- as.data.frame(Nratios)
write.csv(Nratios,"./output/Nratios_rep4.csv", row.names=F)
Nratios<- read.csv("./output/Nratios_rep4.csv")
...
Nratio_transform <- Nratio_sel %>%
  mutate(across(c(wave_1, wave_2), ~paste("wave", ., sep = "_"))) %>%
  mutate(wave_sel= paste(wave_1, wave_2, sep = "_")) %>% select(-group,-coh2,-diff)
write.csv(Nratio_transform, "./output/Nratio_transform_rep4.csv", row.names=F)
Nratio_transform<- read.csv("./output/Nratio_transform_rep4.csv")
com_col <- colnames(wave)[colnames(wave) %in% Nratio_transform$wave_sel]
Nwave_pheno<- wave %>% select(1:10, com_col)
write.csv(Nwave_pheno,"./output/Nwave_pheno_rep4.csv", row.names = F)
Nwave<- read.csv("./output/Nwave_pheno_rep4.csv")
#plotting
...
#replication 5
N <- fread("./output/narea_breakdown5.csv", data.table = F)
phenotypes_whole <- read.table("./data/phenotypes_whole.csv", header = T, sep = ",")
Name2<- unique(phenotypes_whole$Name2)
indv_sample<- read.csv("./data/sample_per_rep.csv")
...
sel$rowname <- paste0(sel$wave_1, "_", sel$wave_2)
Nratios <- wave |> select(wave_1039_wave_390:wave_827_wave_366)
Nratios <- t(Nratios)
colnames(Nratios) <- wave$plot_id
#distance
dist <- get_dist(Nratios, method = "pearson")
...
Nratios<- as.data.frame(Nratios)
write.csv(Nratios,"./output/Nratios_rep5.csv", row.names=F)
Nratios<- read.csv("./output/Nratios_rep5.csv")
...
Nratio_transform <- Nratio_sel %>%
  mutate(across(c(wave_1, wave_2), ~paste("wave", ., sep = "_"))) %>%
  mutate(wave_sel= paste(wave_1, wave_2, sep = "_")) %>% select(-group,-coh2,-diff)
write.csv(Nratio_transform, "./output/Nratio_transform_rep5.csv", row.names=F)
Nratio_transform<- read.csv("./output/Nratio_transform_rep5.csv")
com_col <- colnames(wave)[colnames(wave) %in% Nratio_transform$wave_sel]
Nwave_pheno<- wave %>% select(1:10, com_col)
write.csv(Nwave_pheno,"./output/Nwave_pheno_rep5.csv", row.names = F)
Nwave<- read.csv("./output/Nwave_pheno_rep5.csv")
#plotting
...
N_blues_rep1<- droplevels(N_blues_rep1[N_blues_rep1$taxa %in%rownames(kin), ])#filtering indv that are present both in kinship and phenotypic data
...
N_blues_rep2<- subset(Nblues_rep2, !is.na(taxa))%>%
  select(-name2,-Corrected_names)
N_blues_rep2<- droplevels(N_blues_rep2[N_blues_rep2$taxa %in%rownames(kin), ])#filtering indv that are present both in kinship and phenotypic data
...
N_blues_rep3<- droplevels(N_blues_rep3[N_blues_rep3$taxa %in%rownames(kin), ])#filtering indv that are present both in kinship and phenotypic data
...
N_blues_rep4<- droplevels(N_blues_rep4[N_blues_rep4$taxa %in%rownames(kin), ])#filtering indv that are present both in kinship and phenotypic data
...
N_blues_rep5<- droplevels(N_blues_rep5[N_blues_rep5$taxa %in%rownames(kin), ])#filtering indv that are present both in kinship and phenotypic data
write.csv(N_blues_rep5,"./output/N_blues_rep5.csv", row.names = F)


#----------------2nd step --------------------
N_blues<- read.csv("./output/N_blues_rep1.csv")
...
sort<- create_folds( individuals= N_bluesEF$taxa, nfolds= 5,
                     reps = 20, seed = 123)
kin<- fread('./data/kin_additive.txt', data.table= F)
...
#----- ST Narea for rep2 --------
N_blues<- read.csv("./output/N_blues_rep2.csv")
N_bluesEF<- N_blues %>% filter(env== "EF")
N_bluesMW<- N_blues %>% filter(env== "MW")
N_bluesEF<- N_bluesEF%>% mutate(taxa= factor(taxa))
N_bluesMW<- N_bluesMW%>% mutate(taxa= factor(taxa))
...
#----- ST Narea for rep3 --------
N_blues<- read.csv("./output/N_blues_rep3.csv")
N_bluesEF<- N_blues %>% filter(env== "EF")
N_bluesMW<- N_blues %>% filter(env== "MW")
N_bluesEF<- N_bluesEF%>% mutate(taxa= factor(taxa))
N_bluesMW<- N_bluesMW%>% mutate(taxa= factor(taxa))
...
#----- ST Narea for rep4 --------
N_blues<- read.csv("./output/N_blues_rep4.csv")
N_bluesEF<- N_blues %>% filter(env== "EF")
N_bluesMW<- N_blues %>% filter(env== "MW")
N_bluesEF<- N_bluesEF%>% mutate(taxa= factor(taxa))
N_bluesMW<- N_bluesMW%>% mutate(taxa= factor(taxa))
...
#----- ST Narea for rep5 --------
N_blues<- read.csv("./output/N_blues_rep5.csv")
N_bluesEF<- N_blues %>% filter(env== "EF")
N_bluesMW<- N_blues %>% filter(env== "MW")
N_bluesEF<- N_bluesEF%>% mutate(taxa= factor(taxa))
N_bluesMW<- N_bluesMW%>% mutate(taxa= factor(taxa))
